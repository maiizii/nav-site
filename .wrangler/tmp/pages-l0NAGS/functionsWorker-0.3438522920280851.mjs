...
// ../.wrangler/tmp/bundle-HdJoXd/strip-cf-connecting-ip-header.js
...
async function verifyJWT(token, secret) {
  try {
    ...
    if (!headerB64 || !payloadB64 || !signatureB64)
      return null;
    const addPadding = /* @__PURE__ */ __name((str) => {
      while (str.length % 4) {
        str += "=";
      }
      return str;
...
// ../.wrangler/tmp/pages-l0NAGS/functionsRoutes-0.010181394785511055.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-HdJoXd/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-HdJoXd/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.3438522920280851.mjs.map
